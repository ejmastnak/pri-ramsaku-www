export default {
  ...
  p2: {
    en: "Since stock varies from season to season and we only make them on a small scale, we typically arrange purchase of our \"special products\" on a case-by-case basis directly with our customers.",
    sl: "Ker te izdelke pridelujemo v manjšem obsegu in izdelki niso vedno na zalogi se v tem primeru za nakup dogovorimo neposredno s strankami. Veseli bomo vašega povpraševanja — ",
  },
  contact: {
    en: "Contact us to arrange details.",
    sl: "kontaktirajte nas, da dorečemo detajle.",
  },
}
