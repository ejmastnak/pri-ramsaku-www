...
`,
  ...
  sntoljDescription: {
    en: `
Saint John's Wort oil is herbal product made by infusing the flowers of the Saint John's Wort plant in a carrier oil. It is traditionally used in Slovenia to soothe and heal damaged skin, to soothe aching joints, and as a luxurious massage oil.
`,
    sl: "Šentjanževo olje je zeliščni izdelek, narejen z namakanjem cvetov šentjanževke v olju. Uporabljamo ga za lajšanje bolečin in celjenje kože pri lažjih opeklinah in odrgninah, za blažitev bolečin v sklepih, in kot dragoceno masažno olje.",
  },
  otherTitle: {
    en: "Other products",
    sl: "Drugi izdelki",
